...
class Admin extends React.Component {
  ...
  submitQuestionRequest = () => {
    ...
    const postData = { department: department, question: question, choices: choices }
      ...
      <div className="admin-container">
        ...
        <div className="container-column">
          <div className="container-content">
            ...
            <div className="button-container">
              <Button variant="contained" color="primary" className={classes.button}>
                <input className={classes.button} type="file" onChange={this.readResgisterFile} />
                选择文件
              </Button>
          ...
          <div className="container-content">
            ...
            <div className="button-container">
              <Button variant="contained" color="primary" className={classes.button}>
                <input className={classes.button} type="file" onChange={this.readQuestionFile} />
                选择文件
              </Button>
        ...
        <div className="container-column">
          <div className="container-content">
            ...
            <div className="container-form">
              <form className={classes.container} noValidate autoComplete="off" ref="form">
              ...
              <div className="button-container">
                <Button variant="contained" color="primary" className={classes.button} onClick={this.addChoice}>
                  添加选项
                </Button>
                <Button variant="contained" color="primary" className={classes.button} onClick={this.submitQuestionRequest}>
                  提交
                </Button>
              </div>
            </div>
